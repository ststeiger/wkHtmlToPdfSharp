...
namespace wkHtmlToPdfSharp
{
    ...
    /// <code>SynchronizedwkHtmlToPdfSharp</code> from <code>wkHtmlToPdfSharp.Synchronized</code> package.
    /// </summary>
    public class SimplewkHtmlToPdfSharp : IwkHtmlToPdfSharp, IDisposable
    {
        ...
        {
            int expectedPhaseCount = wkHtmlToPdfSharpStatic.GetPhaseCount(converter);
        ...
        {
            int phaseNumber = wkHtmlToPdfSharpStatic.GetPhaseNumber(converter);
            string phaseDescription = wkHtmlToPdfSharpStatic.GetPhaseDescription(converter, phaseNumber);
        ...
        {
            string progressDescription = wkHtmlToPdfSharpStatic.GetProgressDescription(converter);
        ...
        private void CreateConverter()
        {
            ...
            {
                wkHtmlToPdfSharpStatic.DestroyConverter(_converter);
            ...
            _converter = wkHtmlToPdfSharpStatic.CreateConverter(_globalConfigUnmanaged);

            if (_log.IsTraceEnabled)
                _log.Trace("T:" + Thread.CurrentThread.Name + " Created converter");

            wkHtmlToPdfSharpStatic.SetErrorCallback(_converter, _errorCallback);
            wkHtmlToPdfSharpStatic.SetWarningCallback(_converter, _warningCallback);
            wkHtmlToPdfSharpStatic.SetPhaseChangeCallback(_converter, _phaseChangedCallback);
            wkHtmlToPdfSharpStatic.SetProgressChangeCallback(_converter, _progressChangedCallback);
            wkHtmlToPdfSharpStatic.SetFinishedCallback(_converter, _finishedCallback);
        ...
        public SimplewkHtmlToPdfSharp(GlobalConfig config)
        {
            if (_log.IsTraceEnabled)
                _log.Trace("T:" + Thread.CurrentThread.Name + " Creating SimplewkHtmlToPdfSharp");
        ...
        public byte[] Convert(ObjectConfig doc, byte[] html)
        {
            ...
            wkHtmlToPdfSharpStatic.AddObject(_converter, objConf, html);
            ...
            try
            {
                ...
                if (!wkHtmlToPdfSharpStatic.PerformConversion(_converter))
                {
                    if (_log.IsTraceEnabled)
                ...
                // get output
                return wkHtmlToPdfSharpStatic.GetConverterResult(_converter);
            }
            finally
            {
        ...
        {
            get { return wkHtmlToPdfSharpStatic.GetPhaseNumber(_converter); }
        }
        /// <summary>
        ...
        {
            get { return wkHtmlToPdfSharpStatic.GetPhaseCount(_converter); }
        }
        /// <summary>
        ...
        {
            get { return wkHtmlToPdfSharpStatic.GetPhaseDescription(_converter, CurrentPhase); }
        }
        /// <summary>
        ...
        {
            get { return wkHtmlToPdfSharpStatic.GetProgressDescription(_converter); }
        }
        /// <summary>
        ...
        {
            get { return wkHtmlToPdfSharpStatic.GetHttpErrorCode(_converter); }
        }
    }
}
