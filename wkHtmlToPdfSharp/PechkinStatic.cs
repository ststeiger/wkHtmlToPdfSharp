...
namespace wkHtmlToPdfSharp
{
    ...
    /// </summary>
    public static class wkHtmlToPdfSharpStatic
    {
        private static readonly ILog Log = LogManager.GetCurrentClassLogger();

        private static bool _inited;
        private static bool _useHack;
        private static System.IntPtr _handleSO;

// ReSharper disable NotAccessedField.Local
        private static SimplewkHtmlToPdfSharp _hackObj;
// ReSharper restore NotAccessedField.Local


        private static string GetFullResourceName(System.Reflection.Assembly ass, string resName)
        {

            foreach (string strResourceName in ass.GetManifestResourceNames())
            {
                if (strResourceName.EndsWith(resName, StringComparison.InvariantCultureIgnoreCase))
                {
                    Console.WriteLine("Found: {0}", strResourceName);
                    return strResourceName;
                }
            }

            throw new Exception(string.Format("Embedded resource \"{0}\"not found.", resName));
        }
        ...
        public static IntPtr CreateGlobalSetting()
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_create_global_settings();
        }
        public static IntPtr CreateObjectSettings()
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_create_object_settings();
        }
        public static int SetGlobalSetting(IntPtr setting, string name, string value)
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(setting, name, value);
        }
        public static string GetGlobalSetting(IntPtr setting, string name)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_get_global_setting(setting, name, ref buf, buf.Length);
        ...
        public static int SetObjectSetting(IntPtr setting, string name, string value)
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(setting, name, value);
        }
        public static string GetObjectSetting(IntPtr setting, string name)
        {
            ...
            byte[] buf = new byte[2048];
            wkHtmlToPdfSharpBindings.wkhtmltopdf_get_object_setting(setting, name, ref buf, buf.Length);
        ...
        public static IntPtr CreateConverter(IntPtr globalSettings)
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_create_converter(globalSettings);
        }
        public static void DestroyConverter(IntPtr converter)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_destroy_converter(converter);
        }
        public static void SetWarningCallback(IntPtr converter, StringCallback callback)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_set_warning_callback(converter, callback);
        }
        public static void SetErrorCallback(IntPtr converter, StringCallback callback)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_set_error_callback(converter, callback);
        }
        public static void SetFinishedCallback(IntPtr converter, IntCallback callback)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_set_finished_callback(converter, callback);
        }
        public static void SetPhaseChangeCallback(IntPtr converter, VoidCallback callback)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_set_phase_changed_callback(converter, callback);
        }
        public static void SetProgressChangeCallback(IntPtr converter, IntCallback callback)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_set_progress_changed_callback(converter, callback);
        }
        ...
        public static bool PerformConversion(IntPtr converter)
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_convert(converter) != 0;
        }
        ...
        public static void AddObject(IntPtr converter, IntPtr objectConfig, string html)
        {
            ...
            wkHtmlToPdfSharpBindings.wkhtmltopdf_add_object(converter, objectConfig, html);
        }
        ...
        public static int GetPhaseNumber(IntPtr converter)
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_current_phase(converter);
        }
        ...
        public static int GetPhaseCount(IntPtr converter)
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_phase_count(converter);
        }
        ...
        public static string GetPhaseDescription(IntPtr converter, int phase)
        {
            ...
            IntPtr pStr = wkHtmlToPdfSharpBindings.wkhtmltopdf_phase_description(converter, phase);
        ...
        public static string GetProgressDescription(IntPtr converter)
        {
            ...
            IntPtr pStr = wkHtmlToPdfSharpBindings.wkhtmltopdf_progress_string(converter);
            return Marshal.PtrToStringAnsi(pStr);
        }
        ...
        public static int GetHttpErrorCode(IntPtr converter)
        {
            ...
            return wkHtmlToPdfSharpBindings.wkhtmltopdf_http_error_code(converter);
        }
        ...
        public static byte[] GetConverterResult(IntPtr converter)
        {
            /*
            IntPtr unmanagedBuf;
            long length = wkHtmlToPdfSharpBindings.wkhtmltopdf_get_output(converter, out unmanagedBuf);
            ...
            */
            ...
            IntPtr tmp;
            var len = wkHtmlToPdfSharpBindings.wkhtmltopdf_get_output(converter, out tmp);
        ...
        public static string Version
        {
            get
            {
                ...
                return wkHtmlToPdfSharpBindings.wkhtmltopdf_version();
            }
        }
        ...
        public static bool EntendedQtAvailable
        {
            get
            {
                ...
                return wkHtmlToPdfSharpBindings.wkhtmltopdf_extended_qt() != 0;
            }
        }
