...
namespace wkHtmlToPdfSharp.Util
{
    ...
    public class ConstUtf8Marshaler : ICustomMarshaler
    {
        static ConstUtf8Marshaler _staticInstance;
        ...
        public IntPtr MarshalManagedToNative(object managedObj)
        {
            ...
            if (!(managedObj is string))
                throw new MarshalDirectiveException("ConstUtf8Marshaler must be used on a string.");
            ...
            IntPtr ptrPosEnd = new IntPtr(lngPosEnd);
