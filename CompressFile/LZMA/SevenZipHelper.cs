    ...
    public static class SevenZipHelper
    {
        ...
        public static byte[] Compress(byte[] inputBytes)
        {
            ...
            using (System.IO.MemoryStream strmInStream = new System.IO.MemoryStream(inputBytes))
            {
                ...
                } // End Using strmOutStream

            } // End Using strmInStream 
        ...
        public static void Decompress(System.IO.Stream strmInStream, string outFileName)
        {
            SevenZip.Compression.LZMA.Decoder decoder = new SevenZip.Compression.LZMA.Decoder();
        ...
        public static string DecompressToCurDirWithFilename(System.IO.Stream strmInStream, string fileName)
        {
            string outFileName = System.Reflection.Assembly.GetExecutingAssembly().Location;
            outFileName = System.IO.Path.GetDirectoryName(outFileName);
            outFileName = System.IO.Path.Combine(outFileName, fileName);
