...
using wkHtmlToPdfSharp.Logging;
    ...
    public class ObjectConfig
    {
        public class HeaderSettings
        {
            ...
            internal void SetUpObjectConfig(IntPtr config, string prefix)
            {
                if (_fontSize != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "fontSize", _fontSize);
                }
                if (_fontName != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "fontName", _fontName);
                }
                if (_leftText != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "left", _leftText);
                }
                if (_centerText != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "center", _centerText);
                }
                if (_rightText != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "right", _rightText);
                }
                if (_lineSeparator != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "line", _lineSeparator);
                }
                if (_space != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "space", _space);
                }
                if (_htmlUrl != null)
                {
                    wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, prefix + "." + "htmlUrl", _htmlUrl);
                }
            }
        }
        ...
        */
        ...
        internal void SetUpObjectConfig(IntPtr config)
        {
            ...
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "toc.useDottedLines", _tocUseDottedLines);
            }
            if (_tocCaption != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "toc.captionText", _tocCaption);
            }
            if (_tocCreateLinks != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "toc.forwardLinks", _tocCreateLinks);
            }
            if (_tocBackLinks != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "toc.backLinks", _tocBackLinks);
            }
            if (_tocIndentation != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "toc.indentation", _tocIndentation);
            }
            if (_tocFontScale != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "toc.fontScale", _tocFontScale);
            }
            if (_createToc != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "isTableOfContent", _createToc);
            }
            if (_includeInOutline != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "includeInOutline", _includeInOutline);
            }
            if (_pagesCount != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "pagesCount", _pagesCount);
            }
            if (_tocXsl != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "tocXsl", _tocXsl);
            }
            if (_pageUri != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "page", _pageUri);
            }
            if (_useExternalLinks != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "useExternalLinks", _useExternalLinks);
            }
            if (_useLocalLinks != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "useLocalLinks", _useLocalLinks);
            }
            if (_produceForms != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "produceForms", _produceForms);
            }
            if (_loadUsername != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.username", _loadUsername);
            }
            if (_loadPassword != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.password", _loadPassword);
            }
            if (_loadJsDelay != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.jsdelay", _loadJsDelay);
            }
            if (_loadZoomFactor != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.zoomFactor", _loadZoomFactor);
            }
            if (_loadRepeatCustomHeaders != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.repertCustomHeaders", _loadRepeatCustomHeaders);
            }
            if (_loadBlockLocalFileAccess != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.blockLocalFileAccess", _loadBlockLocalFileAccess);
            }
            if (_loadStopSlowScript != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.stopSlowScript", _loadStopSlowScript);
            }
            if (_loadDebugJavascript != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.debugJavascript", _loadDebugJavascript);
            }
            if (_loadErrorHandling != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.loadErrorHandling", _loadErrorHandling);
            }
            if (_loadProxy != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "load.proxy", _loadProxy);
            }
            if (_webPrintBackground != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.background", _webPrintBackground);
            }
            if (_webLoadImages != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.loadImages", _webLoadImages);
            }
            if (_webRunJavascript != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.enableJavascript", _webRunJavascript);
            }
            if (_webIntelligentShrinking != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.enableIntelligentShrinking", _webIntelligentShrinking);
            }
            if (_webMinFontSize != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.minimumFontSize", _webMinFontSize);
            }
            if (_webPrintMediaType != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.printMediaType", _webPrintMediaType);
            }
            if (_webDefaultEncoding != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.defaultEncoding", _webDefaultEncoding);
            }
            if (_webUserStylesheetUri != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.userStyleSheet", _webUserStylesheetUri);
            }
            if (_webEnablePlugins != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_object_setting(config, "web.enablePlugins", _webEnablePlugins);
            }
        ...
        {
            IntPtr config = wkHtmlToPdfSharpStatic.CreateObjectSettings();
