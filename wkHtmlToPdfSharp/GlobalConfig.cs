...
namespace wkHtmlToPdfSharp
{
    ...
    public class GlobalConfig
    {
        ...
        public GlobalConfig SetPaperSize(PaperKind kind)
        {
            ...
            if (wkHtmlToPdfSharpStatic.PaperSizes.ContainsKey(kind))
            {
                wkHtmlToPdfSharpStatic.StrPaperSize ps = wkHtmlToPdfSharpStatic.PaperSizes[kind];
        ...
        internal void SetUpGlobalConfig(IntPtr config)
        {
            ...
            if (_paperSize != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "size.paperSize", _paperSize);
            }
            if (_paperWidth != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "size.width", _paperWidth);
            }
            if (_paperHeight != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "size.height", _paperHeight);
            }
            if (_paperOrientation != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "orientation", _paperOrientation);
            }
            if (_colorMode != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "colorMode", _colorMode);
            }
            if (_resolution != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "resolution", _resolution);
            }
            if (_dpi != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "dpi", _dpi);
            }
            if (_pageOffset != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "pageOffset", _pageOffset);
            }
            if (_copies != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "copies", _copies);
            }
            if (_collate != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "collate", _collate);
            }
            if (_outline != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "outline", _outline);
            }
            if (_outlineDepth != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "outlineDepth", _outlineDepth);
            }
            if (_dumpOutline != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "dumpOutline", _dumpOutline);
            }
            if (_output != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "out", _output);
            }
            if (_documentTitle != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "documentTitle", _documentTitle);
            }
            if (_useCompression != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "useCompression", _useCompression);
            }
            if (_marginTop != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "margin.top", _marginTop);
            }
            if (_marginRight != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "margin.right", _marginRight);
            }
            if (_marginBottom != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "margin.bottom", _marginBottom);
            }
            if (_marginLeft != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "margin.left", _marginLeft);
            }
            if (_outputFormat != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "outputFormat", _outputFormat);
            }
            if (_imageDpi != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "imageDPI", _imageDpi);
            }
            if (_imageQuality != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "imageQuality", _imageQuality);
            }
            if (_cookieJar != null)
            {
                wkHtmlToPdfSharpBindings.wkhtmltopdf_set_global_setting(config, "load.cookieJar", _cookieJar);
            }
        }
